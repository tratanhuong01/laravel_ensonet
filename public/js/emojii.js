            ...
            !function(global, factory) {
                ...
                var _createClass = function() {
                  ...
                  , MeteorEmoji = function() {
                    function MeteorEmoji(input,click,modal) {
                    ...
                    return _createClass(MeteorEmoji, [{
                        key: "initiate",
                        value: function(input, click,modal) {
                            var _this = this;
                            _this.generateElements(input,click,modal);
                        }
                    }, {
                        key: "generateElements",
                        value: function(emojiInput,emojiTrigger,emojiContainer) {
                            var clickLink = function(event) {
                                if (emojiInput.tagName === 'TEXTAREA')
                                emojiInput.value += this.innerText;
                                else 
                                emojiInput.innerHTML += this.innerText;
                              ...
                              , clickCategory = function(event) {
                                ...
                                for (i = 0,
                                l = backgroundToggle.length; i < l; i++)
                            ...
                            emojiPicker.classList = 'dark:bg-dark-third',
                            emojiPicker.style.width = "315px",
                            ...
                            emojiTrigger.onclick = function(event) {
                                var y = event.clientY;
                                if (emojiContainer.classList.contains('hidden')) {
                                    emojiContainer.classList.remove('hidden');
                                    emojiPicker.style.display = "block";
                                    if (y < $(window).height()/2) {
                                        emojiContainer.classList.add('top-14')
                                        emojiContainer.classList.remove('bottom-14')
                                    }
                                    else {
                                        emojiContainer.classList.add('bottom-14')
                                        emojiContainer.classList.remove('top-14')  
                                    }
                            ...
                            emojiCategories.map(function(item) {
                                ...
                                "faces" == String(item.name) && (emojiLink.style.background = "#c2c2c2"),
