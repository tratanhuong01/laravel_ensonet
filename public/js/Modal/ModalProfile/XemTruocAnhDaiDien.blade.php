...
style="transform:translate(-50%,-50%);display:block;">
    ...
    <div class="w-full opacity-50 pt-4 relative">
        <img id="avt-opactity" class="mx-auto object-fill" style="width:353px;height:334px;" 
        src="img/avatar.jpg" alt="">
    </div>
    <div class="w-full text-center absolute" style="top: 214px;left:0px;">
        <img id="avt-opactity-none" class="object-fill w-7/12 mx-auto rounded-full border-none p-0.5" 
