...
function openEditFriend(index) {
    ...
    document.getElementsByClassName("main-friends")[0].addEventListener(
        "click",
        function () {
...
for (var a = 0; a < mess_right.length; a++) {
    ...
    mess_user_r[a].style.width =
        mess_user[a].offsetWidth -
        50 -
        mess_user_r1[a].offsetWidth +
        mess_user_r2[a].offsetWidth +
        "px";
}
...
function typeChat(IDTaiKhoan) {
    if ($("#" + IDTaiKhoan + "PlaceTypeText").html().length > 0) {
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.remove("w-8/12");
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.add("w-11/12");
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.add("pl-4");
        ...
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.remove("w-11/12");
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.add("w-8/12");
        document
            .getElementById(IDTaiKhoan + "threeexten1")
            .classList.remove("pl-4");
...
function guiVeri(index) {
    ...
    else content_veri[index].style.display = "none";
}
