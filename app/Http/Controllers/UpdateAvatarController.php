    ...
    public function update(Request $request) {
        try {
            if($request->hasFile('fileAvatar')) {
                ...
                Baidang::add($idBaiDang,$user[0]->IDTaiKhoan,'CHIBANBE',
                $request->content,NULL,NULL,NULL,date("Y-m-d H:i:s"),0);
                ...
                DB::update('UPDATE taikhoan SET AnhDaiDien = ? WHERE IDTaiKhoan = ? ',
