...
<div class="w-full block z-50 fixed top-0 bg-white" id="header">
            <!--div header -->
            <div class="w-full flex px-2 py-1">
                <!-- div header left -->
                <div class="w-1/4 flex ml-1">
                    <div class="pr-4">
                        <!-- ** Logo ** -->
                        <a href="{{ url('index') }}">
                            <img class="w-12 p-0.5" src="img/logo.png" alt="" srcset="">
                        </a>
                    </div>
                    <div class="pr-4 mt-1 w-3/4">
                        <!-- form tìm kiếm -->
                        <form action="" method="get">
                            <input class="w-full p-2.5 outline-none rounded-full border-none bg-gray-100" type="text"
                                name="input" placeholder=" Tìm kiếm trên facebook" />
                        </form>
                    </div>
                </div>
                <div class="w-2/4">
                    <!-- div header center -->
                    <div class=" m-auto wrapper" style="width: 80%;">
                ...
                <div class="w-1/4 pl-8 flex">
                    <!-- header right -->
                    <div class="w-5/12 flex py-0.875 px-2.5 mx-2 mt-1 mb-1.5 p-1.5 hover:bg-gray-200 round-avatar">
                        <div class="w-full">
                            <!-- avatar user  -->
                        ...
                        <div class="w-full pt-1">
                            <!-- name user  -->
                            <a href="" style="font-weight: bold;">{{ $user[0]->Ten }}</a>
                        </div>
                    </div>
                    <div class="w-7/12 pt-2 pb-2">
                        <ul class="w-full flex">
                            ...
                            h-10 ml-1 mr-1">
                                <div onclick="openRequestFriend()" class="pt-1.5">
                                    <a href="{{ url('logout') }}"><i class="fas fa-sign-out-alt text-xl"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
