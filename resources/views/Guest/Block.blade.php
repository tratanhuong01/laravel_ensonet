...
<body class="bg-gray-200">
    <div class="w-1/2 mx-auto p-3 bg-white absolute top-1/3 left-1/2 rounded-lg" style="transform: translate(-50%,-50%);">
        <div class="w-full py-2">
            <p class="font-bold text-xm" style="font-family: system-ui;">Tài khoản của bạn đã bị khóa tạm thời </p>
        </div>
        <hr>
        <div class="w-full py-2">
            ...
            <p class="pt-2">
                ...
                giống <b>&nbsp;Ensonet</b>. Loại tấn công này là lừa đảo . <a href="" class="text-blue-600">Tìm hiểu thêm</a>
            </p>
