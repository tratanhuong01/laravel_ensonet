                    ...
                    style="width:95%;">
                        ...
                        <ul class="w-full ">
                            ...
                            <p class="dark:text-gray-300">&nbsp;<i class="fab fa-foursquare text-gray-600 text-xl 
                                dark:text-gray-300"></i>&nbsp;&nbsp;
                                <span>Có &nbsp;<b class="dark:text-gray-300">1.324</b>&nbsp; người theo dõi</span></p>
                            </li>
                        </ul>
                    </div>
                    <div class="pl-2.5 bg-white m-2.5 rounded-lg  dark:bg-dark-third" 
                    style="width: 95%;">
                        ...
                        <div class="fr-us">
                                <a href=""><img class="rounded-lg"
                                            src="img/avatar.jpg" alt=""></a>
                            </div>
                            <div class="fr-us">
                                <a href=""><img class="rounded-lg"
                                            src="img/avatar.jpg" alt=""></a>
