    ...
    <div class="w-4/5">
        ...
        <div class="w-full flex py-1 text-sm flex">
            <div class="w-4/5 text-sm">
                ...
                @switch($sws)
                @case('0')
                <span class="font-bold {{ DataProcessFive::checkMessageIsSeen($value[count($value) - 1]->IDTinNhan, Session::get('user')[0]->IDTaiKhoan) == 1 ? 'text-gray-500 ' : 'text-blue-500 ' }}">
                ...
                @break
                @case('1')
                <span class="{{ DataProcessFive::checkMessageIsSeen($value[count($value) - 1]->IDTinNhan, Session::get('user')[0]->IDTaiKhoan) == 1 ? 'text-gray-500 ' : 'text-blue-500 ' }}  font-bold">
