            ...
            lg:w-4/6 lg:left-0! xl:w-2/5 xl:left-3/10">
                ...
                <div class="w-full bg-white mb-3 mt-2 dark:bg-dark-second m-auto rounded-lg mb-2">
                    <div class="w-full flex p-2.5 ">
                        ...
                        <div class="w-11/12">
                            <input class="w-full p-3 border-none outline-none bg-gray-200 dark:bg-dark-third" style="border-radius: 40px;" onclick="openPost()" type="text" placeholder="{{ $user[0]->Ten }} ơi, Bạn Đang Nghĩ Gì Thế?">
                        </div>
                    </div>
                    <hr>
                    <div class="w-full">
