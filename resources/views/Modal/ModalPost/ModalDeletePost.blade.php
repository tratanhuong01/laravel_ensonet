...
sm:w-10/12 md:w-2/3 lg:w-2/3 xl:w-1/3" style="transform: translate(-50%,-50%);z-index:10;">
    <div class="w-full relative h-full">
        <div class="w-full text-center">
            ...
            <span onclick="closePost()" class="bg-gray-300 px-2.5 dark:text-white font-bold z-50
        ...
        <div class="w-full h-full absolute top-0 left-0 z-20 bg-opacity-50 
        bg-white hidden" id="loadingDeletePostss">
            <div class="w-full h-full relative">
                <i class="fas fa-spinner fa-pulse absolute top-1/3 left-48% text-3xl 
