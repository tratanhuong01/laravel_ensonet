...
sm:w-10/12 md:w-2/3 lg:w-2/3 xl:w-1/3" style="transform: translate(-50%,-50%);z-index:10;">
    <form action="" id="formPost" enctype="multipart/form-data">
        ...
        <input type="hidden" name="share3Or5" id="share3Or5" value="{{$type}}">
        <div class="w-full text-center">
            <p class="text-2xl font-bold p-2.5 dark:text-white">Viết bài</p>
            ...
            <div class="w-11/12">
                ...
                <div class="py-0 px-1 w-auto w-1/4 bg-gray-300 dark:bg-dark-third" style="border-radius: 30px;">
                    <ul onclick="selectPrivacy()" id="selectPrivacyMain" class="flex text-xs relative cursor-pointer">
                        <li class="px-0.5 py-1.5">
                            <i class="fas fa-globe-europe dark:text-white"></i>
                        </li>
                        <li class="px-0.5 py-1.5">
                            <b class="dark:text-white">&nbsp;Công khai&nbsp;&nbsp;</b>
                        </li>
                        <li class="px-0.5 py-1.5">
                            <i style="position: absolute;top: 6px;" class="fas fa-sort-down dark:text-white"></i>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="w-full mt-2.5 wrapper-content-right overflow-y-auto" style="max-height:365px;">
            ...
            @case('0')
            @include('Component.Post.Child.Share.AvatarPost',
            [
            'item' => $post
            ])
            @break
            @case('1')
            @include('Component.Post.Child.Share.CoverPost',
            [
            'item' => $post
            ])
            @break
            @case('2')
            @include('Component.Post.Child.Share.NormalPost',
            [
            'item' => $post
            ])
            @break
        ...
        <div class="w-full flex p-2 border-2 border-solid border-gray-300 mt-4">
            ...
            <ul class="ml-auto flex" id="placeSelection">
                <label for="uploadFileSSS">
                    ...
                    dark:hover:bg-dark-third justify-center bg-gray-500 text-gray-500">
        ...
        <div class="w-full text-center my-2.5 mx-0">
            <button onclick="SharePostMainS('{{ $post[0]->IDBaiDang }}')" class="w-full p-2.5 border-none text-white cursor-pointer" id="button-post" style="background-color: gray;border-radius: 20px;cursor:not-allowed;" type="button"><b>Đăng </b></button>
        </div>
    </form>
</div>