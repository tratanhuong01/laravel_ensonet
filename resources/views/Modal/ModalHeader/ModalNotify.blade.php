...
?>
<div id="notifyModal" class="w-full">
    <div class="w-full flex">
        <div class="w-1/3">
            <p class="dark:text-gray-300 text-xl py-2 pl-2 cursor-pointer">
                <b>Thông Báo</b>
            </p>
        </div>
        <div class="w-2/3">
            <p onclick="tickAllIsReaded()" class="dark:text-gray-300 text-xm py-2 pl-2 pr-2 cursor-pointer text-right">
    ...
    <div class="w-full py-2">
        <p class="text-center font-bold dark:text-gray-300 cursor-pointer">
