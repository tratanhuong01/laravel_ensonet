...
<div class="w-full">
    ...
    <div class="mess-person cursor-pointer flex relative dark:hover:bg-dark-third hover:bg-gray-200 py-2 px-1">
        <div class="w-1/5">
            <a href=""><img src="img/avatar.jpg" alt="" class="w-14 h-14 rounded-full object-cover p-0.5"></a>
        </div>
        <div class="w-4/5">
            <div class="w-full">
                <span style="float: left;font-weight: bold;">
                    <a href="" class="dark:text-white">Trà Hưởng</a></span>
            </div>
            <div class="w-full flex py-1 text-base flex">
                <div class="w-4/5">
                    <span class="text-gray-500 dark:text-white">You : Lên tập hơi kk. &nbsp;&nbsp;16 giờ</span>
                </div>
                <div class="w-1/5">
