<div id="modal-one" class="border-2 border-solid border-gray-300 py-3 pl-1.5 pr-1.5 pt-0
    ...
    <div class="w-full my-2 px-2">
        <input class="w-full p-2 pl-4 bg-transparent dark:bg-dark-third" style="border-radius: 30px;" type="text" placeholder="Tìm kiếm">
    </div>
    <div class="tac-user wrapper-content-right">
        <div class="tac-user-clone">
            <div class="tac-user-1 pt-0.5">
                <span class="text-2xl">😀</span>
            </div>
            <div class="tac-user-2">
                <p class="dark:text-white">hạnh phúc</p>
            </div>
        </div>
        <div class="tac-user-clone">
            <div class="tac-user-1 pt-0.5">
