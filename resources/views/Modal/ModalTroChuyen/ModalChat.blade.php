...
dark:border-dark-third border-2 border-solid border-gray-300 ml-auto">
            ...
            <ul class="flex justify-end">
                ...
                dark:hover:bg-dark-third">
                    <svg height="26px" width="26px" viewBox="-4 -4 24 24">
                        <line stroke="#bec2c9" stroke-linecap="round" stroke-width="2" x1="2" x2="14" y1="8" y2="8"></line>
                    </svg>
                </li>
        ...
        <div class="w-1/12 flex py-1">
            <div class="cursor-pointer fill-65676B ">
                ...
                dark:hover:bg-dark-third  p-1 ">
                    <svg id="addOrCancel" onclick="loadTextBoxType()" class="a8c37x1j ms05siws hr662l2t b7h9ocf4 crt8y2ji tftn3vyl" height="20px" width="20px" viewBox="0 0 24 24">
                        <g fill-rule="evenodd">
            ...
            <li class="float-left cursor-pointer p-1 fill-65676B hover:bg-gray-200 rounded-full 
                ...
                <svg class="a8c37x1j ms05siws hr662l2t b7h9ocf4" height="20px" width="20px" viewBox="0 -1 17 17">
                    <g fill="gray" fill-rule="evenodd">
                        <path d="M2.882 13.13C3.476 4.743 3.773.48 3.773.348L2.195.516c-.7.1-1.478.647-1.478 1.647l1.092 11.419c0 .5.2.9.4 1.3.4.2.7.4.9.4h.4c-.6-.6-.727-.951-.627-2.151z" fill="gray"></path>
                        <circle cx="8.5" cy="4.5" r="1.5" fill="gray"></circle>
                        <path d="M14 6.2c-.2-.2-.6-.3-.8-.1l-2.8 2.4c-.2.1-.2.4 0 .6l.6.7c.2.2.2.6-.1.8-.1.1-.2.1-.4.1s-.3-.1-.4-.2L8.3 8.3c-.2-.2-.6-.3-.8-.1l-2.6 2-.4 3.1c0 .5.2 1.6.7 1.7l8.8.6c.2 0 .5 0 .7-.2.2-.2.5-.7.6-.9l.6-5.9L14 6.2z" fill="gray"></path>
                        <path d="M13.9 15.5l-8.2-.7c-.7-.1-1.3-.8-1.3-1.6l1-11.4C5.5 1 6.2.5 7 .5l8.2.7c.8.1 1.3.8 1.3 1.6l-1 11.4c-.1.8-.8 1.4-1.6 1.3z" stroke-linecap="round" stroke-linejoin="round" stroke="gray"></path>
                    </g>
                </svg>
            </li>
            <li class="float-left cursor-pointer p-1 fill-65676B  hover:bg-gray-200 rounded-full 
    ...
    dark:border-dark-third border-gray-300">
        <ul class="dark:border-dark-third w-full border-b-2 border-gray-200 border-solid p-2">
            ...
            <li class="w-full p-1.5 text-lg hover:bg-gray-300 text-lg hover:bg-gray-100 dark:hover:bg-dark-third cursor-pointer dark:text-white"><i class="far fa-user-circle pr-1.5"></i>
                Xem trang cá nhân
            </li>
        </ul>
        <ul class="dark:border-dark-third w-full border-b-2 border-gray-200 border-solid p-2">
            <li class="w-full p-1.5 text-lg hover:bg-gray-300 dark:hover:bg-dark-third   cursor-pointer dark:text-white"><i class="fas fa-palette pr-1.5"></i> Màu
            </li>
            <li class="w-full p-1.5 text-lg hover:bg-gray-300 dark:hover:bg-dark-third   cursor-pointer dark:text-white"><i class="far fa-smile pr-1.5"></i> Biểu
                tượng cảm xúc</li>
            <li class="w-full p-1.5 text-lg hover:bg-gray-300 dark:hover:bg-dark-third   cursor-pointer dark:text-white"><i class="fas fa-pen-alt pr-1.5"></i> Biệt
                danh</li>
        </ul>
        <ul class="dark:border-dark-third w-full border-b-2 border-gray-200 border-solid p-2">
