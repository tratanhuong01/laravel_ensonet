...
dark:border-dark-third border-2 border-solid border-gray-300 ml-auto" style="height: 486px;">
    ...
    <div class="w-full bg-white dark:bg-dark-second z-20 pb-2 pt-4 px-1 flex dark:border-dark-third border-t-2 border-solid border-gray-300">
        <div class="w-1/12 flex">
            <div class="cursor-pointer p-1 fill-65676B pt-2">
                <svg class="addOrCancel" onclick="loadTextBoxType(0)" class="a8c37x1j ms05siws hr662l2t b7h9ocf4 crt8y2ji tftn3vyl" height="20px" width="20px" viewBox="0 0 24 24">
                    <g fill-rule="evenodd">
        ...
        <div class="three-exten1 w-6/12">
            <div class="place-input-type border-none rounded-2xl pl-2 outline-none bg-gray-200 py-1.5 w-11/12" style="min-height: 20px;" oninput="typeChat(0)" contenteditable placeholder="Aa">
