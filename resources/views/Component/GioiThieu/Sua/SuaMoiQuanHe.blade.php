<div class="w-full relative marriage hidden">
    ...
    <div class="w-full flex relative h-16 mt-3">
        <div onclick="PrivacyAbout(this,'PrivacyInputMarriage')" class="bg-gray-200  dark:bg-dark-third dark:text-white  rounded-lg p-2 absolute left-0 font-bold">
            <i class="fas fa-globe-europe"></i>&nbsp;&nbsp;Công khai
        </div>
        <div class="bg-1877F2 text-white rounded-lg p-2 absolute right-0 font-bold">
            Lưu
        </div>
        <div id="btnHuyMarriage" class="bg-gray-200  dark:bg-dark-third dark:text-white  rounded-lg p-2 absolute right-12 font-bold">
            Hủy
        </div>
    </div>
</div>