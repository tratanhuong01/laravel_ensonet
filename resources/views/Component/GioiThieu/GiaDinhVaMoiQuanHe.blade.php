...
<div class="w-full">
    <ul class="w-full py-2 px-4 mainAboutFull">
        ...
        <div class="w-full" id="relationShipMain">
            @include('Component/GioiThieu/Data/HonNhan',['data' =>$json->GiaDinhVaCacMoiQuanHe->HonNhan,
        ...
        <div class="w-full" id="memberFamilyMain">
            ...
            @if (sizeof($json->GiaDinhVaCacMoiQuanHe->ThanhVienGiaDinh) < 0) @include('Component/GioiThieu/Xoa/XoaThanhVienGiaDinh') @include('Component/GioiThieu/Them/ThemThanhVienGiaDinh') @else @include('Component/GioiThieu/Xoa/XoaThanhVienGiaDinh') @include('Component/GioiThieu/Them/ThemThanhVienGiaDinh') <li class="w-full pb-4 flex" style="font-size: 16px;">
                <ul class="w-full">
                    @foreach($json->GiaDinhVaCacMoiQuanHe->ThanhVienGiaDinh as $key => $value)
                    @include('Component/GioiThieu/Main/ThanhVienGiaDinh',[
                    'value'=>$value
                    ])
                    @endforeach
                </ul>
