...
<div class="w-7/12 mx-auto flex py-2">
    ...
    <div class="w-5/12 py-1.5 text-right">
        <span class="p-3 mr-2 cursor-pointer"
            style="background-color: #D8DADF;border-radius: 6px;line-height: 24px;"><i
                class="fab fa-facebook-messenger" style="font-size: 20px;"></i>&nbsp;&nbsp;Nhắn tin</span>
        ...
        <span onclick="DeleteFriend('{{ $user[0]->IDTaiKhoan }}','{{ $users[0]->IDTaiKhoan }}')" class="p-3 cursor-pointer" style="background-color: #D8DADF;border-radius: 6px;"><i
                class="fas fa-user-slash huyBanBe"></i></span>
    </div>
</div>