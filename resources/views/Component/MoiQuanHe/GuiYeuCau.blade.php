...
<div class="w-7/12 mx-auto flex py-2">
        ...
        <div class="w-5/12 py-1.5 text-right">
            ...
            <span class="cursor-pointer mr-2 relative hover:"
    ...
    <div class="w-7/12 mx-auto flex py-2">
        ...
        <div class="w-1/4 py-2 text-right my-8">
            <span onclick="CancelRequestFriend()" class="p-3 mr-2 cursor-pointer text-white "
                style="background-color: #1095F4;border-radius: 6px;line-height: 24px;"><i
                    class="fas fa-user-times text-white guiYeuCau" style="font: size 18px;"></i>&nbsp;&nbsp;
                    <span class="main_themBanBe">Hủy kết bạn</span></span>
        </div>
    </div>