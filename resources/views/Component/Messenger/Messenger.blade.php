...
$chater = Taikhoan::where('taikhoan.IDTaiKhoan', '=', '1000000008')->get();
$sender = Tinnhan::where('tinnhan.IDTaiKhoan', '=', Session::get('user')[0]->IDTaiKhoan)
    ...
    ->get();
$receiver = Tinnhan::where('tinnhan.IDTaiKhoan', '=', '1000000008')
    ->join('nhomtinnhan', 'tinnhan.IDNhomTinNhan', 'nhomtinnhan.IDNhomTinNhan')
    ->get();
    ...
    <div class="w-1/2 pl-3 flex">
        <div class="pt-1">
            <div class="w-10 h-10 relative">
                <img src="/img/avatar.jpg" alt="" class="w-10 h-10 object-cover rounded-full">
        ...
        <div class="pl-3">
            <b class="block dark:text-white">Trà Hưởng</b>
