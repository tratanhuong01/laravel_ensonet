...
<div class="w-2/3 flex flex-col">
    ...
    wrapper-content-right overflow-y-auto overflow-x-hidden relative flex-1">
        @if (count($messages) == 0)
    ...
    <div class="w-full bg-white dark:bg-dark-second relative z-20 pb-2 pt-2 px-1 flex dark:border-dark-third border-t-2 border-solid border-gray-300">
        ...
        <ul class="three-exten mr-3 py-1" id="{{ $chater[0]->IDTaiKhoan }}threeexten" style="display: block;">
        ...
        <div class="three-exten1 w-9/12 relative" id="{{$chater[0]->IDTaiKhoan}}threeexten1">
            ...
            <div id="{{$idNhomTinNhan.$chater[0]->IDTaiKhoan}}emojiiss" class="absolute right-14 top-0.5 flex cursor-pointer z-50">
...
<div class="w-1/3 pr-2 wrapper-content-right" style="height: 701px;max-height: 701px;overflow-y: auto;">
    ...
    <ul class="w-full py-2">
        ...
        <li class="w-full py-1">
            <ul class="w-full">
                <li onclick="openChangeColor('{{ $idNhomTinNhan }}', '{{ $chater[0]->IDTaiKhoan }}' )" class="w-full py-2.5 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-dark-third 
