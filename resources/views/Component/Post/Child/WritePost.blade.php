<div class="w-full bg-white mb-3 mt-2 dark:bg-dark-second m-auto rounded-lg mb-2">
    <div class="w-full flex p-2.5 ">
        ...
        <div class="w-11/12">
            ...
            dark:bg-dark-third" style="border-radius: 40px;" onclick="openPost()" type="text" placeholder="{{ $users[0]->Ten }} ơi bạn đang nghĩ gì đó ?">
        </div>
    </div>
    <hr>
    <div class="w-full">
        <ul class="w-full flex">
            ...
            <input type="file" onchange="changeUploadFileMain(this)" id="uploadFileS" name="files[]" accept="image/*,video/*" multiple="multiple" class="hidden">
