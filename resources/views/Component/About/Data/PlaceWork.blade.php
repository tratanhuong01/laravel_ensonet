<li class="w-full py-4 flex relative" id="{{ $data->IDCongViec }}PlaceWork" style="font-size: 16px;">
    ...
    <div class="w-2/12">
        <ul class="w-full flex justify-end">
            ...
            <li class="p-2 dark:text-white text-gray-600">
                ...
                @case('CONGKHAI')
                <i onclick="changePrivacyAboutMain('changePlaceWork','{{ $data->IDCongViec }}',this)" class="fas fa-globe-europe text-xl cursor-pointer"></i>
                @break
                @case('CHIBANBE')
                <i onclick="changePrivacyAboutMain('changePlaceWork','{{ $data->IDCongViec }}',this)" class="fas fa-user-friends text-xl cursor-pointer"></i>
                @break
                @case('RIENGTU')
                <i onclick="changePrivacyAboutMain('changePlaceWork','{{ $data->IDCongViec }}',this)" class="fas fa-lock  text-xl cursor-pointer"></i>
                @break
                @endswitch
            </li>
