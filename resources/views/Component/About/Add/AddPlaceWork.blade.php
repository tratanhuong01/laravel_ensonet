...
<div class="w-full placeWork hidden relative">
    ...
    <div class="w-full flex relative h-16 pt-3 ">
        ...
        <div onclick="add(dashboard.routes.ProccessAddPlaceWorkAbout,
        'placeWork',
        'placeWorkMain')" class="cursor-pointer bg-1877F2 text-white ml-3 rounded-lg p-2 absolute right-0 font-bold">
            Lưu
        </div>
