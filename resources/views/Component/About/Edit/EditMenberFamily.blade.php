<div class="w-full">
    <div class="w-full relative">
        ...
        <div class="absolute top-16 z-30 h-72 bg-gray-200 dark:bg-dark-second overflow-y-auto border-gray-300 rounded-lg
    ...
    <div class="w-full relative">
        <div class="w-full my-2 p-2.5 border-2 border-solid border-gray-200 
                dark:bg-dark-third dark:border-dark-main shadow-lg dark:text-white  resize-none outline-none rounded-lg h-12"></div>
