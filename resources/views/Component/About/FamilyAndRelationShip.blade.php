    ...
    <ul class="w-full py-2 px-4 mainAboutFull">
        ...
        <div class="w-full relative hidden">
            ...
            <div class="w-full flex relative h-16 mt-3">
                ...
                <div
                    class="bg-gray-200  dark:bg-dark-third dark:text-white  rounded-lg p-2 absolute right-12 font-bold">
                    Hủy
                </div>
            </div>
        </div>
        ...
        <div class="w-full" id="memberFamilyMain">
            @if ($idMain == $idView)
                ...
                @if (sizeof(json_decode($json[0]->JsonGioiThieu)->GiaDinhVaCacMoiQuanHe->ThanhVienGiaDinh) < 0)
                    @include('Component/About/Delele/DeleteMemberFamily')
                    @include('Component/About/Add/AddMemberFamily')
                @else
                    @include('Component/About/Delete/DeleteMemberFamily')
                    @include('Component/About/Add/AddMemberFamily') <li class="w-full pb-4 flex"
